        ...
        <View style={styles.spotContent}>
          ...
          {spot.location_text && (
            <View style={styles.locationRow}>
              ...
              <Text style={styles.spotLocation}>{spot.location_text}</Text>
            </View>
          )}
          ...
          {spot.difficulty && (
            <Text style={styles.spotDifficulty}>Difficulty: {spot.difficulty}</Text>
          )}
          
          {spot.trail_length && (
            <Text style={styles.spotDistance}>Distance: {spot.trail_length} miles</Text>
          )}
